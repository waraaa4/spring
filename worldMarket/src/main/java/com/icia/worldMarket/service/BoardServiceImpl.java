...
import com.icia.worldMarket.dto.BoardDTO;
import com.icia.worldMarket.dto.PageDTO;
import com.icia.worldMarket.repository.BoardRepository;
...
//		List<BoardDTO> pagingList = br.pagingList(pagingStart);
	...
	public void save(BoardDTO board) throws IllegalStateException, IOException {
		...
		// 파일 저장 경로 세팅
		String savePath = "C:\\development\\source\\spring\\worldMarket\\src\\main\\webapp\\resources\\upload\\"+b_filename;
